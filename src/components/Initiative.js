...
import fullTextInitiative from '../file/fullTextInitiative.pdf'
...
const Initiative = () => {
    return (
        <div className='w-bg wide-90 m-l-5vw'>
            ...
            <h2 className = 'self-center s-title wg-bg mt-0 mt-lg-3'>Initiative</h2>
            <br/>
            <embed src = {fullTextInitiative} className = "h-100vh wide-100" />
            <br />
